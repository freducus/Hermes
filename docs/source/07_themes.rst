...
.. list-table:: ``Theme`` fields
   ...
   * - ``palette``
     ...
     - Primary, secondary, accent, background,
       ...
       Plus ``extras`` for user-defined colours.
   * - ``typography``
     - ``Typography``
     - Font specs for headings (3 levels), body,
       caption, code, mono.
       Plus ``extras`` for user-defined styles.
...
Only ``page_size``, ``palette`` and ``typography`` are needed:
...
Instantiate the custom theme and pass it directly to a slide:
